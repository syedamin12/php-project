...
<body onload="fetchPosts_DB('home');">
    ...
    <div class="main_container" align="center">
        ...
        <div class="row">
                ...
                <div class="centerCol">
                    <div id="centerCol_Content">
                        <div class="homeLinks" style="text-align:<?php echo lang('homeLinks'); ?>">
                            ...
                            <a href="./u/<?php echo $_SESSION['Username']; ?>&ut=photos">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f5fb.png" /> <?php echo lang('my_photos'); ?></p>
                            </a>
                            <a href="./settings">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/2699.png" /> <?php echo lang('settings'); ?></p>
                            </a>
                            <a href="./settings?tc=language">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f998c4.png" /> <?php echo lang('language'); ?></p>
                            </a>

                            <p class="homeLinks_title"><?php echo lang('my_notepad'); ?></p>
                            <a href="./mynotepad/new">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/270f.png" /> <?php echo lang('new_note'); ?></p>
                            </a>
                            <?php
                            $msid = $_SESSION['id'];
                            ...
                            while ($note_i = $get_notes->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                ?>
                                <a href="./mynotepad/">
                                    <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f5d2.png" /> <?php if (strlen($get_note_title) > 20) {
                                                                                                                            $noteitem = substr($get_note_title, 0, 20) . "...";
                                                                                                                        } else {
                                                                                                                            $noteitem = $get_note_title;
                                                                                                                        }
                                                                                                                        echo $noteitem; ?></p>
                                </a>
                            <?php
                            ...
                            ?>
                            <a href="./mynotepad/">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f4d1.png" /> <?php echo lang('see_all_notes') . "<span>" . thousandsCurrencyFormat($notesCount) . "</span>"; ?></p>
                            </a>
                            ...
                            while ($getS_row = $getS->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                while ($getuser_row = $getuser->fetch(PDO::FETCH_ASSOC)) {
                                    ?>
                                    <a href="u/<?php echo $getuser_row['Username']; ?>">
                                        <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/user_imgs/<?php echo $getuser_row['Userphoto']; ?>" style="border-radius: 100%;" /> <?php echo $getuser_row['Fullname']; ?></p>
                                    </a>
                            <?php
                                }
                            }
                            ?>
                            <a href="./u/<?php echo $_SESSION['Username']; ?>&ut=stars">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f4ab.png" /> <?php echo lang('see_all_notes'); ?></p>
                            </a>

                            <p class="homeLinks_title"><?php echo lang('more'); ?></p>
                            <a href="./posts/saved">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f516.png" /> <?php echo lang('saved_posts'); ?></p>
                            </a>
                            <a href="page/supportbox">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f4e5.png" /> <?php echo lang('supportBox'); ?></p>
                            </a>
                            <a href="page/report">
                                <p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f4e4.png" /> <?php echo lang('Report_A_Problem'); ?></p>
                            </a>
            ...
            <!--====================================[ Center col3 ]============================================-->
            <div class="col-md-3 col-sm-3">
                <div id="centerCol3" style="width: 100%">
