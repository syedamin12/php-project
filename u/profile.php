...
<body onload="fetchPosts_DB('user')">
    ...
    if (filter_var(htmlspecialchars($_GET['u']), FILTER_SANITIZE_STRING) == $row_username) {
        ?>
        <!--=============================[ Container ]=====================================-->
        <div class="profile_sec1_sec2 container" align="center">
            <div class="row">
            <div class="profile_cover col-md-12 col-sm-12 col-xs-12">
                <?php
            ...
            <div class="profile_menu col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="profile_cneterCol col-md-4 col-sm-4 col-xs-4">
                    <div class="user_info">
                        <?
                            if ($row_username == $_SESSION['Username']) {
                                $userActive = "#4CAF50";
                        ...
                        <div class="profile_picture_img profile_ppicture" style="<?php echo $profile_pic_border_var; ?>">
                            ...
                            ";
                                    ...
                                    <div class="profile_picture">
                                        <h3 style="margin-top:30px; "><?php echo "<a href='" . $row_username . "'>$row_fullname</a>";
                                                                            if ($row_verify == "1") {
                                                                                echo $verifyUser;
                                                                            } ?></h3>
                                    ...
                                    <table>
                                        <?php
                                            if (empty($row_school) && empty($row_work0) && empty($row_work) && empty($row_country) && empty($row_birthday) && empty($row_website)) {
                                                echo "<p>" . lang('nothingToShow') . "</p>";
                                            }
                                            if (!empty($row_school)) {
                                                echo "<tr><td class='user_info_tdi'><i class=\"fa fa-graduation-cap\"></i></td><td>" . lang('studies') . " $row_school<td></tr>";
                                            }
                                            if (!empty($row_work0) || !empty($row_work)) {
                                                echo "<tr><td class='user_info_tdi'><i class=\"fa fa-briefcase\"></i></td><td>" . lang('working') . " $row_work0 " . lang('at') . " $row_work<td></tr>";
                                            }
                                            if (!empty($row_country)) {
                                                echo "<tr><td class='user_info_tdi'><i class=\"fa fa-map-marker\"></i></td><td>" . lang('lives_in') . " $row_country<td></tr>";
                                            }
                                            if (!empty($row_birthday)) {
                                                echo "<tr><td class='user_info_tdi'><i class=\"fa fa-calendar\"></i></td><td>" . lang('born_on') . " $row_birthday<td></tr>";
                                            }
                                            if (!empty($website_row)) {
                                                echo "<tr><td class='user_info_tdi'><i class=\"fa fa-globe\"></i></td><td>$website_row<td></tr>";
                                            }
                                            ?>
                                    </table>
                                </div>
                                <div class="user_info">
                                    <p style="font-size: 18px;"><?php echo lang('bio'); ?></p>
                                    <hr style="margin: 0;margin-bottom: 10px;">
                                    <?php
                                        if (!empty($row_bio)) {
                                            echo "
                ...
                <div class="profile_cneterCol_2 col-md-8 col-sm-8 col-xs-8">
                    <?php
