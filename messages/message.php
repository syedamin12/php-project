...
<body>
				...
				<div class="messages_col3">
					...
					<div class="mCol3_userInfo">
						...
						<h4 style="text-align: center;">
							<div style="width: 60%; height: 10px; background: rgba(217, 221, 224, 0.55); margin: auto;"></div>
						</h4>
						<p style="text-align:center;margin: 0px;color: gray">
							<div style="width: 40%; height: 10px; background: rgba(217, 221, 224, 0.55); margin: auto;"></div>
						</p>
					</div>
	...
	<script type="text/javascript">
		...
		function getIn2Sec() {
			if ($('.mCol2_title').attr('data-user') == "0") {} else {
